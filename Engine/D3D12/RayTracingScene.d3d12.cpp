...
void RayTracingScene::BuildAccelerationStructure(CommandContext& CommandContext)
{
	...
	AccelerationStructureView = Adapter->CreateShaderResourceView(AccelerationStructureBuffer.get(), EF_Unknown).cast<ShaderResourceView>();
	...
	{
		InstanceBuffer =white::unique_raw(Adapter->CreateBuffer(Buffer::Dynamic, white::underlying(EAccessHint::CPUWrite),
