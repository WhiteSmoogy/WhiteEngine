...
template< typename T, white::uint32 blockSize >
...
template< typename T, white::uint32 blockSize >
TUnrolledLinkList<T, blockSize>::TUnrolledLinkList()
	: freeNode( &head )
	, num(0)
{
...
template< typename T, white::uint32 blockSize >
void TUnrolledLinkList<T, blockSize>::Add( const T& Element )
{
...
template< typename T, white::uint32 blockSize >
void TUnrolledLinkList<T, blockSize>::Remove( const T& Element )
{
...
template< typename T, white::uint32 blockSize >
void TUnrolledLinkList<T, blockSize>::Remove( const TIterator& i )
{
	wconstraint( num > 0 );
	wconstraint( i.index < num );
...
template< typename T, white::uint32 blockSize >
void TUnrolledLinkList<T, blockSize>::Clear()
{
	delete head.next;
	head.next = NULL;
	head.prev = NULL;
