...
namespace platform::Render
{
	inline namespace Shader
	{
		...
		struct FShaderPermutationBool
		{
			...
			{
				WAssert(PermutationId == 0 || PermutationId == 1, white::sfmt("Invalid shader permutation dimension id %i.", PermutationId).c_str());
		...
		struct TShaderPermutationInt
		{
			...
			static int32 ToDimensionValueId(Type E)
			{
				...
				WAssert(PermutationId < PermutationCount&& PermutationId >= 0, white::sfmt("Unknown shader permutation dimension value id %i.",PermutationId).c_str());
			...
			static Type FromDimensionValueId(int32 PermutationId)
			{
				WAssert(PermutationId < PermutationCount&& PermutationId >= 0, white::sfmt("Invalid shader permutation dimension value id %i.", PermutationId).c_str());
		...
		struct TShaderPermutationSparseInt
		{
			...
			static int32 ToDimensionValueId(Type E)
			{
				WAssert(false, white::sfmt("Unknown shader permutation dimension value %i.", E).c_str());
				return int32(0);
			}
			...
			static Type FromDimensionValueId(int32 PermutationId)
			{
				WAssert(false, white::sfmt("Invalid shader permutation dimension id %i.", PermutationId).c_str());
				return Type(0);
			}
		};
		...
		*/
		...
		struct TShaderPermutationDomain
		{
			...
			{
				WAssert(PermutationId == 0, white::sfmt("Invalid shader permutation id %i.", PermutationId).c_str());
			}
		...
		struct TShaderPermutationDomain<TDimension, Ts...>
		{
			...
			{
				WAssert(PermutationId >= 0 && PermutationId < PermutationCount, white::sfmt("Invalid shader permutation id %i.", PermutationId).c_str());
			}
...
#define SHADER_PERMUTATION_INT(InDefineName, Count) \
	DECLARE_SHADER_PERMUTATION_IMPL(InDefineName, platform::Render::TShaderPermutationInt, white::int32, Count)
...
#define SHADER_PERMUTATION_RANGE_INT(InDefineName, Start, Count) \
	DECLARE_SHADER_PERMUTATION_IMPL(InDefineName, platform::Render::TShaderPermutationInt, white::int32, Count, Start)
...
#define SHADER_PERMUTATION_ENUM_CLASS(InDefineName, EnumName) \
	DECLARE_SHADER_PERMUTATION_IMPL(InDefineName, platform::Render::TShaderPermutationInt, EnumName, static_cast<white::int32>(EnumName::MAX))