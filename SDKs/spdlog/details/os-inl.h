...
SPDLOG_INLINE void wstr_to_utf8buf(wstring_view_t wstr, memory_buf_t &target)
{
    ...
    throw_spdlog_ex(std::format("WideCharToMultiByte failed. Last error: {}", ::GetLastError()));
}
...
SPDLOG_INLINE void utf8_to_wstrbuf(string_view_t str, wmemory_buf_t &target)
{
    ...
    throw_spdlog_ex(std::format("MultiByteToWideChar failed. Last error: {}", ::GetLastError()));
}
