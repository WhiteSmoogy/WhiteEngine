...
namespace
{
	...
	void CompressNormalMap(std::string const& in_file, std::string const& out_file, EFormat new_format)
	{
		...
		platform::X::SaveTexture(out_file, in_type, out_width, out_height, in_depth, in_num_mipmaps, in_array_size, new_format,white::make_span(new_data));
