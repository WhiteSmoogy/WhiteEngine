...
private:
	...
	void RenderShadowDepth()
	{
		...
		if (!ShadowMap || ShadowMap->GetWidth(0) < LayoutWidth || ShadowMap->GetHeight(0) < LayoutHeight)
			ShadowMap = white::share_raw(Device.CreateTexture(LayoutWidth, LayoutHeight, 1, 1, render::EFormat::EF_D32F, render::EA_GPURead | render::EA_DSV, {}));
	...
	void OnCreate() override {
		...
		ShadowMapMask = white::share_raw(Device.CreateTexture(1280, 720, 1, 1, EFormat::EF_ABGR16F, EAccessHint::EA_GPURead | EAccessHint::EA_RTV, {}));
		...
		ShadowMap = white::share_raw(Device.CreateTexture(4096, 4096, 1, 1, EFormat::EF_D32F, EAccessHint::EA_GPURead | EAccessHint::EA_DSV, {}));
